...
namespace witchclass.Content.Buffs
{
	...
	/// </summary>
	public class MoltenBrew : ModBuff
	{
		...
		public override void Update(NPC npc, ref int buffIndex) {
			npc.GetGlobalNPC<GlobalNPCModification>().MoltenBrewDebuffIndex = 1; 
			npc.GetGlobalNPC<GlobalNPCModification>().MoltenBrewDebuff = true;
		}
	}
}
