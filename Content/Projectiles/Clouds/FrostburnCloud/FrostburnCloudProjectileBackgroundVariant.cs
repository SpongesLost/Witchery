...
{
    public class FrostburnCloudProjectileBackgroundVariant : BaseCloudProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(8)) {
				Dust dust = Dust.NewDustDirect(Projectile.position+new Vector2((random.NextSingle()-0.5f)*16f,(random.NextSingle()-0.5f)*16f), Projectile.width, Projectile.height, DustID.IceTorch);
			}
        }
    }
}