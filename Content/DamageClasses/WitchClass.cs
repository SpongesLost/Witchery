...
namespace witchclass.Content.DamageClasses
{
	public class WitchClass : DamageClass
	{
		...
		public override void SetDefaultStats(Player player) {
			...
			//player.GetCritChance<WitchClass>() += 4;
			//player.GetArmorPenetration<WitchClass>() += 10;
			//player.GetDamage<WitchClass>() += 4;
